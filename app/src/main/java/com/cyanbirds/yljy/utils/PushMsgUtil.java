package com.cyanbirds.yljy.utils;
...
import com.cyanbirds.yljy.activity.VoipCallActivity;
...
import com.cyanbirds.yljy.entity.PushMsgModel;
	...
	public synchronized void handlePushMsg(boolean isPassThroughMsg, String pushMsgJson) {
		...
		if (pushMsgModel != null && !TextUtils.isEmpty(pushMsgModel.sender)) {
			if (pushMsgModel.msgType == PushMsgModel.MessageType.VOIP) {
				if (!AppManager.getTopActivity(CSApplication.getInstance()).equals("com.cyanbirds.yljy.activity.VoipCallActivity")) {
